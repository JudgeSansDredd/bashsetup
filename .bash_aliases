...
alias vhaltf="cd ~/Projects/ap_ops; vagrant halt spensa -f; cd -"
...
alias vstartall="cd ~/Projects/ap_ops; _vcomm spensa 'sudo supervisorctl start all;'; cd -"
alias vstopall="cd ~/Projects/ap_ops; _vcomm spensa 'sudo supervisorctl stop all;'; cd -"
...
alias insights="cd ~/Projects/ap_web/ap_ops_insights"
